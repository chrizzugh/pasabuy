...
export default {
  ...
  methods: {
    ...
    saveUser() {
      ...
      api
        .post("/api/register", {
          email: dataform.personal.email,
          password: dataform.account.password,
          firstName: dataform.personal.firstName,
          lastName: dataform.personal.lastName,
          phoneNumber: dataform.personal.phoneNumber,
          landMark: dataform.address.landMark,
          houseNumber: dataform.address.houseNumber,
          province: dataform.address.province,
          barangay: dataform.address.barangay,
          cityMunicipality: dataform.address.cityMunicipality,
        })
        .then((res) => {
