  ...
  methods: {
    ...
    nextPage() {
      ...
      console.log(this.addressInfo);
       ...
       axios
          .post('https://pasabuy-server.herokuapp.com/api/postAddress', this.addressInfo,{withCredentials: true}).then((res) => {
    ...
    getProvCode() {
      ...
      console.log(getProvCode)
       axios
          .get('https://pasabuy-server.herokuapp.com/api/refcityMunicipality', {params:{provCode: getProvCode}},{withCredentials: true}).then((res)=>{
    ...
    getCityCode() {
     var getCityCode = document.getElementById("City").value;
      console.log(getCityCode)
       axios
          .get('https://pasabuy-server.herokuapp.com/api/refBrgy', {params:{cityCode: getCityCode}},{withCredentials: true}).then((res)=>{
    ...
    refProvince() {
       axios
          .get("https://pasabuy-server.herokuapp.com/api/refProvince",{withCredentials: true}).then((res) => {
