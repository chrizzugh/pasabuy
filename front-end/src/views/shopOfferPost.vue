<template>
  ...
  >
    ...
    >
      ...
      <div
        @click.self="deliveryAreaModal = !deliveryAreaModal,  this.areaError = null,this.selectedBrgy = 'Brgy',this.selectedProvince= 'Province',this.selectedCity= 'City'"
                ...
                >
                  <ul id="myUL" class="space-y-1">
                    <li
                      ...
                      "
                    >
                      <a href="#" :id="'sp' + index">{{ sp.shoppingPlace }}</a>
                    </li>
                  </ul>
                </div>
              </div>
                ...
                >
                  <ul id="myUL" class="space-y-1">
                    <li
                      ...
                      "
                    >
                      <a href="#" :id="'tm' + index">{{ tm.transportMode }}</a>
                    </li>
                  </ul>
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    // getHomeAddressValue() {
    //   this.deliveryArea = document.getElementById("homeAdd").innerHTML;
