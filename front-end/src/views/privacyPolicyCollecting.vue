<template>
    <div class="pt-6 font-nunito">
        <div id="helpCreateAcc" class="items-center flex justify-center w-full  pb-16 bg-transparent px-3 ">
            <div class="overflow-hidden space-y-3  font-bold text-left bg-transparent w-full rounded-xl">
                <div >
                    <h1 class="space-x-1 space-y-1 text-2xl">Collecting and Using Your Personal Data</h1>
                </div> 
                <h2 class="text-3xl  ">Types of Data Collected</h2>
                    <div class="flex">
                        <h1 class="text-2xl">Personal Data</h1>
                        <button @click="isOpen=!isOpen" class=" focus:outline-none font-bold">
                ...
                <!----sub section 2---->
                    ...
                    <div class="w-full text-align-left justify">
                            <div v-if="isOpen1">
                                ...
                                <p>
                                    ...
                                    mobile device You use, Your mobile device unique ID, the IP address of Your mobile device,
                    ...
                    <div class="w-full text-align-left justify">
                            <div v-if="isOpen2">
                                ...
                                <p>
                                    ...
                                    account.If You choose to provide such information and Personal Data, during registration or otherwise, 
                    ...
                    <div class="w-full text-align-left justify">
                            <div v-if="isOpen3">
                                ...
                                <li>
                                    Flash Cookies. Certain features of our Service may use local stored objects (or Flash Cookies) to collect and store information about Your preferences 
                                    or Your activity on our Service. Flash Cookies are not managed by the same browser settings as those used for Browser Cookies. For more information on how 
                                ...
                                <p>
                                    ...
                                    The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time 
                                    You use the Website.
                                </p>
                                <p>
                                ...
                                <p>
                                    ...
                                    <li>For the performance of a contract: the development, compliance and undertaking of the purchase contract for the products, items or services 
                                        You have purchased or of any other contract with Us through the Service.</li>
                                    <li>To contact You: To contact You by email, telephone calls, SMS, or other equivalent forms of electronic communication, such as a mobile application's 
                                        push notifications regarding updates or informative communications related to the functionalities, products or contracted services, including the 
                                        security updates, when necessary or reasonable for their implementation.</li>
                                    <li>To provide You with news, special offers and general information about other goods, services and events which we offer that are similar to those that 
                                        you have already purchased or enquired about unless You have opted not to receive such information.</li>
                                    <li>To manage Your requests: To attend and manage Your requests to Us.</li>
                                    <li>For business transfers: We may use Your information to evaluate or conduct a merger, divestiture, restructuring, reorganization, dissolution, or 
                                        other sale or transfer of some or all of Our assets, whether as a going concern or as part of bankruptcy, liquidation, or similar proceeding, 
