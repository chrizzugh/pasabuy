<template class="bg-gray-bgcolor">
  ...
  <div
    class="flex pb-24 flex-wrap pt-8 overflow-hidden llg:justify-center llg:px-10 mv:pt-5 vs:pt-9 bg-gray-bgcolor vs:flex-col sm:flex-col font-nunito md:flex-col"
  >
    <div
      class="w-3/5 overflow-hidden llg:w-65 vs:w-full xsm:w-full sm:w-full md:w-full ssm:w-full"
    >
      <div class="pt-5 bg-gray-100 mv:pt-1 font-nunito rounded-xl llg:pl-5">
        ...
        >
          ...
          <div class="flex items-center justify-center pt-16 dv:float-right">
            <div
              class="inline-flex items-center justify-center p-6 space-x-4 w-608 bg-white shadow rounded-xl ssm:space-x-2 vs:w-full sm:w-full ssm:w-full ssm:p-2 vs:p-4 rounded-x md:w-full mv:w-screen"
            >
              <img
          ...
          >
            <div
              class="justify-center h-auto bg-transparent ssm:px-0 dv:space-x-4 mv:w-full ssm:p-2 ssm:w-full vs:w-full sm:w-full dv:w-608 rounded-xl"
            >
              <div
              ...
              >
                ...
                <!---------OPTIONS----------->
                <div
                  class="absolute z-20 ssm:float-left ssm:right-0 ssm:left-0 right-60 font-bold origin-top-right lvs:left-48 bg-white rounded-lg shadow-lg w-44 top-15 ssm:top-266 2xl:left-58 2xl:w-60 focus:outline-none mv:right-2"
                  role="menu"
                  aria-orientation="vertical"
                  aria-labelledby="options-menu"
                >
          ...
          >
            ...
            >
              ...
              <div
                id="fkmouse"
                class="modal-body cursor-not-allowed px-2"
              ></div>
              <div
                id="modal-footer"
    ...
    <div
      class="w-2/5 pt-20 overflow-hidden llg:w-35 pl-7 vs:hidden ssm:hidden md:hidden sm:hidden xsm:hidden"
    >
      <!-----------ACTIVE ORDERS---------------------->
      <div class="mb-6 bg-white shadow-md w-72 rounded-2xl">
        ...
        >
          ...
          <span
            ...
            class="cursor-pointer inline-flex pl-20 pr-3 align-bottom material-icons-round md-18"
          >
            navigate_before
          </span>
          <span
            v-else
            class="inline-flex cursor-pointer text-gray-300 pl-20 pr-3 align-bottom material-icons-round md-18"
          >
            navigate_before
          </span>
          ...
          <span
            ...
            class="cursor-pointer inline-flex align-bottom material-icons-round md-18"
          >
            navigate_next
          </span>
          <span
            v-else
            class="inline-flex cursor-pointer text-gray-300 align-bottom material-icons-round md-18"
          >
            navigate_next
          </span>
        </header>
        ...
        <div v-if="confirmedOrders.length != 0">
          ...
          >
            ...
            <div class="absolute h-10 p-2 mr-2 rounded-full right-2 bg-success">
              ...
              <router-link
                :to="'/messages/?ID=' + confirmedOrders[0].transactionSender"
                class="font-bold align-top cursor-pointer mmd:text-base mmd:inline-block"
              ></router-link>
            </div>
          </div>
      ...
      >
        ...
        >
          ...
          <span
            ...
            class="select-none cursor-pointer inline-flex pl-16 pr-3 align-bottom material-icons-round md-18"
          >
            navigate_before
          </span>
          <span
            v-else
            class="select-none text-gray-300 cursor-pointer inline-flex pl-16 pr-3 align-bottom material-icons-round md-18"
          >
            navigate_before
          </span>
          ...
          <span
            ...
            class="cursor-pointer select-none inline-flex align-bottom material-icons-round md-18"
          >
            navigate_next
          </span>
          <span
            v-else
            class="cursor-pointer select-none text-gray-300 inline-flex align-bottom material-icons-round md-18"
          >
            navigate_next
          </span>
        </header>
        ...
        <div v-if="confirmedDeliveries.length != 0">
          ...
          >
            <button class="top-0 left-0 pl-2 rounded-full border-1">
              <img
                class="w-10 h-10 rounded-full"
                :src="confirmedDeliveries[0].transaction_sender.profilePicture"
                alt=""
              />
            </button>
            <div class="ml-2">
            ...
            <div class="absolute h-10 p-2 mr-2 rounded-full bg-success right-2">
              ...
              <router-link
                :to="
                  '/messages/?ID=' + confirmedDeliveries[0].transaction_sender
                "
                class="font-bold align-top cursor-pointer mmd:text-base mmd:inline-block"
              ></router-link>
            </div>
