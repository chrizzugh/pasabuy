<template class=" font-nunito">
    ...
    <div id="verifyemail" class="flex items-center justify-center w-full  px-6  ">
      <div class="w-full my-12 overflow-hidden  bg-white shadow-md rounded-xl
       xl:w-100 lg:w-100 2xl:w-100  px-4 py-4
      md:w-97 sm:w-97
      ">
        <div class="px-4 ">
    ...
    methods:{
        nextPage(){
            var params = {code:this.code, textCode:this.textCode} 
             axios
          .post('http://localhost:8000/api/confirmVerificationCode',params,{withCredentials: true,xsrfCookieName: 'XSRF-TOKEN',
